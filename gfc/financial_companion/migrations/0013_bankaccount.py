# Generated by Django 4.1.3 on 2023-01-24 12:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number',
                 encrypted_fields.fields.EncryptedCharField(max_length=8,
                ...
                ('sort_code',
                 encrypted_fields.fields.EncryptedCharField(max_length=6,
                                                            validators=[financial_companion.models.accounts_model.only_int,
                                                                        django.core.validators.MinLengthValidator(6,
                                                                                                                  'Sort code must be 6 digits long')])),
                ('iban',
                 encrypted_fields.fields.EncryptedCharField(blank=True,
                                                            max_length=33,
                                                            null=True,
                                                            validators=[financial_companion.models.accounts_model.iban_valid,
                                                                        django.core.validators.MinLengthValidator(15,
                                                                                                                  'Iban must be a minimum of 15 characters long')])),
