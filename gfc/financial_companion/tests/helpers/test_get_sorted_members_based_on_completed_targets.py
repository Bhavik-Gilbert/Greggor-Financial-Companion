...
class GetSortedMembersBasedOnCompletedTargetsHelperFunctionTestCase(HelperTestCase):
    ...
    def test_order_is_correct(self):
        ...
        sorted_members_list = get_sorted_members_based_on_completed_targets(self.members)
