...
class GetProjectionBalancesHelperFunctionTestCase(HelperTestCase):
    ...
    def setUp(self):
        self.bank_accounts: Union[QuerySet, list[BankAccount]] = BankAccount.objects.filter(interest_rate__gt=0)
    ...
    def _get_no_accounts(self):
        self.bank_accounts: Union[QuerySet, list[BankAccount]] = BankAccount.objects.filter(id__lt=0)
