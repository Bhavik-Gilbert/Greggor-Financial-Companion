...
class ConvertCurrencyHelperFunctionTestCase(HelperTestCase):
    ...
    def _assert_convert_currency(self, before_amount: float, current_currency_code: str, target_currency_code: str, equal: bool):
    ...
    def _assert_valid_change_or_error_convert_currency(self, before_amount: float, current_currency_code: str, target_currency_code: str, equal: bool=False):
        ...
        self._assert_valid_valid_or_error(self._assert_convert_currency, error_message, warning_message, assert_convert_currency_args)
    ...
    def test_valid_currencies_supported(self):
        ...
        for current_currency_code in CurrencyType:
            ...
            self._assert_valid_change_or_error_convert_currency(before_amount, current_currency_code, target_currency_code)
    ...
    def test_valid_amount_same_if_same_current_and_target_currency_codes(self):
        ...
        before_amount: float = 100
        self._assert_valid_change_or_error_convert_currency(before_amount, current_currency_code, target_currency_code, True)
