...
class QuizscoreViewTestCase(ViewTestCase):
    ...
    def setUp(self):
        ...
        self.quiz_score: QuizScore = QuizScore.objects.filter(user=self.user)[0]
    ...
    def test_invalid_redirects_quiz_score_at_pk_does_not_exist(self):
        ...
        self.assertTrue(any(message.message == 'The score specified does not exist' for message in messages_list))
